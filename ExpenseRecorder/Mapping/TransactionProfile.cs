...
public class TransactionProfile : Profile
{
	...
	{
		CreateMap< TransactionCreateUpdateRequest , Transaction >().ForMember( t => t.Type, opt => opt.MapFrom( r => FromStringToEnum( r.Type ) ) ) ;

		CreateMap< Transaction , TransactionResponse >().ForMember( t => t.Type, opt => opt.MapFrom( r => r.Type.ToString() ) ) ;
	}
}
